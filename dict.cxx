//
// File generated by rootcint at Wed Feb 26 19:26:41 2014
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TSpiceData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TSpiceData", ::TSpiceData::Class_Version(), "/opt/DetectorSimulations/detectorSimulations/dataRootClass/TSpiceData.h", 27,
...
extern "C" void G__set_cpp_environmentdict() {
  ...
  G__add_compiledheader("/opt/DetectorSimulations/detectorSimulations/dataRootClass/TSpiceData.cpp");
...
static int G__dict_220_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_TSpiceData));
...
static int G__dict_220_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((TSpiceData*) G__getstructoffset())->GetSpicePhiEDetectorNbr((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((TSpiceData*) G__getstructoffset())->GetSpicePhiEStripNbr((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) TSpiceData::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TSpiceData::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TSpiceData::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_40(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TSpiceData::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_41(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) TSpiceData::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) TSpiceData::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_220_0_43(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_220_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_220_0_45(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__dict_220_0_46(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_inheritancedict() {
   ...
   /* Setting up class inheritance */
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__dictLN_TSpiceData))) {
     TSpiceData *G__Lderived;
     G__Lderived=(TSpiceData*)0x1000;
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__dictLN_TSpiceData),G__get_linked_tagnum(&G__dictLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
   }
}
...
extern "C" void G__cpp_setup_typetabledict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<TVector3>",117,G__get_linked_tagnum(&G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlETVector3cOallocatorlETVector3gRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlETVector3cOallocatorlETVector3gRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR));
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memvarTSpiceData(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dictLN_TSpiceData));
   { TSpiceData *p; p=(TSpiceData*)0x1000; if (p) { }
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"fSpice_Theta_DetNbr=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"fSpice_Theta_StripNbr=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<Double_t>"),-1,4,"fSpice_Theta_Energy=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"fSpice_Phi_DetNbr=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"fSpice_Phi_StripNbr=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<Double_t>"),-1,4,"fSpice_Phi_Energy=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR),G__defined_typename("vector<TVector3>"),-1,4,"fPositionFirstHit=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<Double_t>"),-1,4,"fPrimaryTheta=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<Double_t>"),-1,4,"fPrimaryPhi=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<Double_t>"),-1,4,"fPrimaryEnergy=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"fPrimaryPdg=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"fPdg=",0,(char*)NULL);
...
static void G__setup_memfuncTSpiceData(void) {
   /* TSpiceData */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dictLN_TSpiceData));
   G__memfunc_setup("TSpiceData",962,G__dict_220_0_1, 105, G__get_linked_tagnum(&G__dictLN_TSpiceData), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,G__dict_220_0_2, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Dump",406,(G__InterfaceMethod) NULL,121, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("GetSpiceThetaEMult",1777,G__dict_220_0_4, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpiceThetaEDetectorNbr",2475,G__dict_220_0_5, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpiceThetaEStripNbr",2179,G__dict_220_0_6, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpiceThetaEEnergy",1977,G__dict_220_0_7, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpicePhiEMult",1564,G__dict_220_0_8, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpicePhiEDetectorNbr",2262,G__dict_220_0_9, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpicePhiEStripNbr",1966,G__dict_220_0_10, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSpicePhiEEnergy",1764,G__dict_220_0_11, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPositionFirstHit",1954,G__dict_220_0_12, 117, G__get_linked_tagnum(&G__dictLN_TVector3), -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEventNumber",1419,G__dict_220_0_13, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPrimaryTheta",1530,G__dict_220_0_14, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPrimaryPhi",1317,G__dict_220_0_15, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPrimaryEnergy",1646,G__dict_220_0_16, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPrimaryPdg",1311,G__dict_220_0_17, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPdg",571,G__dict_220_0_18, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSpiceThetaEDetectorNbr",2487,G__dict_220_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - det", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSpiceThetaEStripNbr",2191,G__dict_220_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Nr", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSpiceThetaEEnergy",1989,G__dict_220_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - E", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSpicePhiEDetectorNbr",2274,G__dict_220_0_22, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - det", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSpicePhiEStripNbr",1978,G__dict_220_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Nr", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSpicePhiEEnergy",1776,G__dict_220_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - E", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPositionFirstHit",1966,G__dict_220_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TVector3' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetEventNumber",1431,G__dict_220_0_26, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPrimaryTheta",1542,G__dict_220_0_27, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - theta", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPrimaryPhi",1329,G__dict_220_0_28, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - phi", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPrimaryEnergy",1658,G__dict_220_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - energy", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPrimaryPdg",1323,G__dict_220_0_30, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - pdg", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPdg",583,G__dict_220_0_31, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - pdg", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_220_0_32, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TSpiceData::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_220_0_33, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSpiceData::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_220_0_34, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TSpiceData::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_220_0_35, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TSpiceData::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_220_0_39, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_220_0_40, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSpiceData::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_220_0_41, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TSpiceData::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_220_0_42, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSpiceData::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_220_0_43, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TSpiceData::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TSpiceData", 962, G__dict_220_0_44, (int) ('i'), G__get_linked_tagnum(&G__dictLN_TSpiceData), -1, 0, 1, 1, 1, 0, "u 'TSpiceData' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TSpiceData", 1088, G__dict_220_0_45, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_220_0_46, (int) ('u'), G__get_linked_tagnum(&G__dictLN_TSpiceData), -1, 1, 1, 1, 1, 0, "u 'TSpiceData' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__dictLN_TSpiceData = { "TSpiceData" , 99 , -1 };
...
G__linked_taginfo G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR = { "vector<TVector3,allocator<TVector3> >" , 99 , -1 };
G__linked_taginfo G__dictLN_reverse_iteratorlEvectorlETVector3cOallocatorlETVector3gRsPgRcLcLiteratorgR = { "reverse_iterator<vector<TVector3,allocator<TVector3> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtabledict() {
  ...
  G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR.tagnum = -1 ;
  G__dictLN_reverse_iteratorlEvectorlETVector3cOallocatorlETVector3gRsPgRcLcLiteratorgR.tagnum = -1 ;
}
...
extern "C" void G__cpp_setup_tagtabledict() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_TSpiceData),sizeof(TSpiceData),-1,29952,"SpiceData structure",G__setup_memvarTSpiceData,G__setup_memfuncTSpiceData);
   ...
   G__get_linked_tagnum_fwd(&G__dictLN_vectorlETVector3cOallocatorlETVector3gRsPgR);
   G__get_linked_tagnum_fwd(&G__dictLN_reverse_iteratorlEvectorlETVector3cOallocatorlETVector3gRsPgRcLcLiteratorgR);
}
